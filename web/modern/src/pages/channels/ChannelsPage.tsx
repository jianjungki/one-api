    ...
    const updateTestingModel = async (id: number, testingModel: string | null) => {
        try {
            ...
            if (res.data?.success) {
                ...
                setData((prev) =>
                    prev.map((ch) => (ch.id === id ? { ...ch, testing_model: testingModel } : ch))
                );
                notify({
                    type: 'success',
                ...
                const msg =
                    res.data?.message || t('channels.notifications.testing_model_failed_message');
                notify({
                    type: 'error',
        ...
        >
            <div className="flex gap-2 w-full md:w-auto">
                <Button
                    ...
                    className={cn(
                        'gap-2 flex-1 md:flex-none whitespace-nowrap',
