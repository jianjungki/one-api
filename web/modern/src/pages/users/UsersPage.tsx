    ...
    const columns: ColumnDef<UserRow>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                const timestampSec =
                    timestampMs && timestampMs > 0 ? Math.floor(timestampMs / 1000) : undefined;
                return (
                    <TimestampDisplay timestamp={timestampSec} className="text-sm" fallback="-" />
                );
            },
        },
        {
    ...
    const toolbarActions = (
        <div className={cn('flex gap-2', isMobile ? 'flex-col w-full' : 'items-center')}>
            ...
            <div className="flex gap-2 w-full">
                <select
                    className={cn(
                        'h-9 border rounded-md px-3 py-2 text-sm flex-1',
